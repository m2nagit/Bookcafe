...
public class bookGUI3 extends JFrame implements ActionListener, ListSelectionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("대여")) {
			...
			String value = (String) table.getValueAt(row, 0); // 책 이름의 col은 0.
			for (Book b : BM.Bbooks) {
			...
			String value = (String) table_1.getValueAt(row, 0); // 책 이름의 col은 0.
			for (Book b : BM.Bbooks) {
				if ((b.name).equals(value))
					b.returnBook();
			}
